...
const iconPath = path.join(__dirname,'images/Brainware_University.png');
const versionItam = '1.0.2';
...
function setGlobalVariable(){
  ...
  session.defaultSession.cookies.get({ url: 'http://www.eprompto.com' })
    .then((cookies) => { 
      ...
      //   width: 392,
      //   height: 520,
      //   icon: __dirname + '/images/Brainware_University.png',
...
ipcMain.on('form_data',function(e,form_data){  
  ...
  ticket_email = form_data['ticket_email'];
  ticket_number = form_data['ticket_no'];
 ...
 console.log('asset_id'+asset_id);
  var body = JSON.stringify({ "funcType": 'ticketInsert', "tic_type": form_data['type'], "loginID": loginid, "calender": calendar_id,
    ...
    "accept": is_accept, "wi_step": resolver_wi_step, "partner_tic": is_partner_ticket, "ticket_password": ticket_password,"ticket_email": ticket_email, "ticket_number": ticket_number}); 
...
autoUpdater.on('update-downloaded', () => {
  // notifier.notify(
  //   {
  //     title: 'ITAM Version 1.0.3 Released. Click to Restart Application.', //put version number of future release. not current.
  //     message: 'ITAM will be Updated on Application Restart.',
  //     icon: path.join(app.getAppPath(), '/images/Brainware_University.png'),
  //     sound: true,
  //     wait: true, 
